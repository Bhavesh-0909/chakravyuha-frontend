...
function Page() {
  return (
        ...
        style={{ backgroundImage: "url('https://i.ytimg.com/vi/X-XZx1o_w-A/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDJAQ9n0xReA2UghZBuQzN2BzcXXA')" }}
        >
            {/* Dark Overlay */}
